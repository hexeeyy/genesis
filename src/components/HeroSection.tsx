          ...
          <div ref={textRef} className="space-y-8 z-10 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <button
                ...
                className="group border border-palette-victorian-navy bg-palette-victorian-cream/80 text-palette-ocean hover:bg-gradient-to-r hover:from-palette-sage hover:to-palette-ocean hover:text-palette-victorian-cream px-8 py-3 rounded-sm font-medium transition-all duration-300 flex items-center gap-3 font-inter text-sm tracking-wide shadow-soft hover:shadow-victorian"
              >
