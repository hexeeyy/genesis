  ...
  const projects = [
    {
      ...
      description:
        'Investigating the effects of multitasking on learning retention and academic performance among university students at National University - Manila',
      type: 'Research Study',
      duration: '8 months',
      status: 'Completed',
    },
    {
      ...
      description:
        'Developing group therapy protocols and digital interventions for adolescents experiencing social anxiety in online learning environments',
    ...
    },
    {
      ...
      description:
        'Comprehensive literature review on effective stigma reduction strategies in mental health treatment within Filipino cultural context',
      type: 'Academic Paper',
      duration: '4 months',
      status: 'Published',
    },
        ...
        <div className="space-y-16">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-inter font-light leading-relaxed">
              Academic work focused on understanding human behavior and developing evidence-based interventions for mental health
            </p>
          </div>
          ...
          <div className="text-center">
            <button
              ...
              className="border border-sage text-sage hover:bg-sage hover:text-white px-8 py-3 rounded-sm font-medium transition-all duration-300 font-inter text-sm tracking-wide"
            >
